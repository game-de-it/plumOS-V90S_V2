#!/usr/bin/env python3
"""Build signed plumOS V90S Runtime or System update archives."""
...
def build_system(args: argparse.Namespace) -> tuple[dict[str, Any], list[tuple[Path, dict[str, Any]]]]:
    ...
    manifest: dict[str, Any] = {
        ...
        "runtime_abi_min": args.runtime_abi,
        "runtime_abi_max": args.runtime_abi,
        "kernel_update": False,
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path(os.environ.get(
            "PLUMOS_V90S_UPDATE_SIGNING_KEY",
    ...
    output = args.output_dir / f"plumos-v90s-{args.type}-{args.version}.tar.gz"
